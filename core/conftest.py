...
from core.db.utils import create_database, drop_database
from src.IR_Test.services.rabbit.dependencies import get_rmq_channel_pool
from src.IR_Test.services.rabbit.lifetime import init_rabbit, shutdown_rabbit
...
async def _engine() -> AsyncGenerator[AsyncEngine, None]:
    ...
    :yield: new engine.
    """
    from core.db.meta import meta  # noqa: WPS433
    from core.db.models import load_all_models  # noqa: WPS433
